          ...
          <div className="flex items-center justify-between">
            <div className="flex gap-2 items-center">
              <a
                ...
                download
                className="bg-white h-9 rounded-full flex items-center justify-center text-dark text-xl opacity-75 hover:opacity-100 hover:shadow-md outline-none px-3"
              >
                <MdDownloadForOffline />
                <p className="text-base ml-1">Download</p>
              </a>
            </div>
            <a href={pinDetails.destination} target="_blank" rel="noreferrer">
              {pinDetails.destination.length > 20
                ? pinDetails.destination.slice(8, 22)
